...
class SuggestionAdapter(
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        when (position) {
            ...
            5 -> {
                holder.toggleButton.textOn = "Bathrooms"
                holder.toggleButton.textOff = "Bathrooms"
            }
            6 -> {
            ...
            9 -> {
                holder.toggleButton.textOn = "Entrances & Exits"
                holder.toggleButton.textOff = "Entrances & Exits"
            }
